...
path = "../Dataset/Covid19_Vaccine_AdditionalFeatures_Labelled.csv"
...
df2['Unique ID'] = df1['Unique ID'].map(lambda x: x+330)
...
df3['Unique ID'] = df3['Unique ID'].map(lambda x: x+660)
...
# df4['Unique ID'] = df4['Unique ID'].map(lambda x: x+990)
